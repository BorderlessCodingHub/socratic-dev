  ...
  return (
    <section className='p-3 md:p-6'>
      <motion.div
        ...
        className='relative flex min-h-[400px] items-center justify-center overflow-hidden rounded-lg bg-gradient-to-br from-pastel-greige via-pastel-mist/70 to-pastel-lavender/60 lg:min-h-[460px]'
      >
        ...
        <div className='relative z-10 mx-auto max-w-[1000px] px-6 py-12 text-center sm:px-10 lg:px-16 lg:py-16'>
          ...
          <h1 className='mx-auto mb-5 max-w-[860px] font-heading text-[38px] leading-[1.04] font-light tracking-[-0.04em] text-ink sm:text-[56px] lg:mb-7 lg:text-[72px] lg:leading-[1.02]'>
            {t.title}
          </h1>
