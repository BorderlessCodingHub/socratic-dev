...
import type { LibraryChallenge } from '@/features/challenges/queries'
...
function stackLabel(c: LibraryChallenge): string {
  if (c.kind === 'design') return 'System Design'
  return stackById(c.stack)?.label ?? c.stack
}

function cardGlyph(c: LibraryChallenge): string {
...
function dedupe(list: LibraryChallenge[]): LibraryChallenge[] {
